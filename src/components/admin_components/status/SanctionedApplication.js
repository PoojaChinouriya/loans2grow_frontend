...
const SanctionedApplication = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://127.0.0.1:8000/v1/applicationview?status=sanctioned');
    ...
    return (
        <div>
            ...
            <h1 className="blockquote text-center">Sanctioned Applications</h1>
...
export default SanctionedApplication