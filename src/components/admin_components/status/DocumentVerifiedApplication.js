...
const DocumentVerifiedApplication = () => {
    const [data, setData] = useState([]);

    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://127.0.0.1:8000/v1/applicationview?status=document_verified');
    ...
    return (
        <div>
            <h1 className="blockquote text-center">Document Verified Applications</h1>
...
export default DocumentVerifiedApplication